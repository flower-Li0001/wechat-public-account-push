  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '生日', name: '宝宝', year: '2003', date: '03-17',
        },
        //{
        //  type: '节日', name: '相恋纪念日', year: '2024', date: '06-09',
        //},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '臭宝', year: '2000', date: '07-16',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2024', date: '06-09',
        }
      ],
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        //{ keyword: 'kaoyan_day', date: '2024-12-21' },
        // 退伍日
    ...
    },
    {
      ...
      useTemplateId: 'Demo_1 ID:24x3wdp_wmsmMoEeqm51z_F49rn9MBPcKy5LccCL4ro',
      province: '河北',
      city: '沧州',
      horoscopeDate: '',
      horoscopeDateType: '',
